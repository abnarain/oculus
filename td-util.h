...
#define IS_DATA_DATA(x)         ((x) &                       0x0)
#define IS_DATA_DATA_CF_ACK(x)         ((x) &                0x1)
#define IS_DATA_DATA_CF_POLL(x)         ((x) &               0x2)
#define IS_DATA_DATA_CF_ACK_POLL(x)         ((x) &           0x3)
#define IS_DATA_NODATA(x)         ((x) &                     0x4)
#define IS_DATA_NODATA_CF_ACK(x)         ((x) &              0x5)
#define IS_DATA_NODATA_CF_POLL(x)         ((x) &             0x6)
#define IS_DATA_NODATA_CF_ACK_POLL(x)         ((x) &         0x7)

#define IS_DATA_QOS_DATA(x)         ((x) &                   0x8)
#define IS_DATA_QOS_DATA_CF_ACK(x)         ((x) &            0x9)
#define IS_DATA_QOS_DATA_CF_POLL(x)         ((x) &           0xA)
#define IS_DATA_QOS_DATA_CF_ACK_POLL(x)         ((x) &       0xB)
#define IS_DATA_QOS_NODATA(x)         ((x) &                 0xC)
#define IS_DATA_QOS_CF_POLL_NODATA(x)         ((x) &         0xE)
#define IS_DATA_QOS_CF_ACK_POLL_NODATA(x)         ((x) &     0xF)
